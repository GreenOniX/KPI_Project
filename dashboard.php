...
<html lang="en">
          ...
          <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            ...
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                <li><a class="dropdown-item" href="employee1.php">Иван</a></li>
  ...
  <div id="container">  
    <div class="container-flex text-center text-md-start m-4 ps-md-5">
      <h1>Добро пожаловать <?php echo $user_data['user_name']; ?> </h1>
    </div>
    ...
    <div class="col-4 mt-5 order-sm-2">
        ...
        <div class="col-sm-8 mt-5 order-sm-1">
          ...
          <div class="container-sm">
            ...
            <script src="incomechart.js"></script>
          </div>
